...
if __name__ == '__main__':
    ...
    PC = PyCrown(F_CHM, F_DTM, F_DSM, F_LAS, outpath=sys.argv[5])
    # Cut off edges
    ...
    PC.tree_detection(PC.chm, ws=2, ws_in_pixels=False, resolution=1, hmin=2.5)
    ...
    PC.crown_delineation(algorithm='dalponteCIRC_numba', th_tree=15.,
                         th_seed=0.7, th_crown=0.55, max_crown=42.)
